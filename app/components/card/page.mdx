...
## Introduction
Cards are surfaces that display content and actions on a single topic. The Wind-Ui Card compenent includes several complementary utility components to handle various use cases:
...
<Tabs items={['Preview', 'code']}>
  ...
  <Tabs.Tab value='Code'>
    ...
    import Card from 'wind-ui/Card'
    import CardActions from 'wind-ui/CardActions'
    import CardContent from 'wind-ui/CardContent'
    import CardHeader from 'wind-ui/CardHeader'
...
import { EllipsisVertical } from 'lucide-react'
// or
import { Card, CardHeader, CardContent, CardActions, Button, Avatar, IconButton, Typography } from 'wind-ui'
import { EllipsisVertical } from 'lucide-react'
```
```jsx
<Card>
