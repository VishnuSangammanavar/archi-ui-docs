...
<Tabs items={['Preview', 'code']}>
  ...
  <Tabs.Tab value='Code'>
    ...
    import SpeedDial from 'wind-ui/SpeedDial'
    import SpeedDialAction from 'wind-ui/SpeedDialAction'
    import SpeedDialIcon from 'wind-ui/SpeedDialIcon'
    ...
    export default function MyReactPage() {
      ...
      const actions = [
        {icon: <IconButton color='warning' className='hover:bg-gray-200' size='sm'><span>S</span></IconButton>, name: 'Send'},
        {icon: <IconButton color='info' className='hover:bg-gray-200' size='sm'><span>D</span></IconButton>, name: 'Delete'},
        {icon: <IconButton color='error' className='hover:bg-gray-200' size='sm'><span>S</span></IconButton>, name: 'Share'},
        {icon: <IconButton color='success' className='hover:bg-gray-200' size='sm'><span>W</span></IconButton>, name: 'Whatsapp'},
      ];

      return (
        <div className="relative flex-grow-1 w-full bg-accent" style={{ height: '300px' }}>
          <SpeedDial
            className='absolute'
...
import SpeedDial from 'wind-ui/SpeedDial'
import SpeedDialAction from 'wind-ui/SpeedDialAction'
import SpeedDialActions from 'wind-ui/SpeedDialActions'
import SpeedDialIcon from 'wind-ui/SpeedDialIcon'
import IconButton from 'wind-ui/IconButton'
// or
import { SpeedDial, SpeedDialAction, SpeedDialAction, SpeedDialIcon, IconButton } from 'wind-ui'
```
```jsx
<SpeedDial
  icon={<SpeedDialIcon icon={'+'} openIcon={'X'} open={openSpeedDial} />}
