...
<Tabs items={['Preview', 'code']}>
  ...
  <Tabs.Tab value='Code'>
    ...
    import Input from 'wind-ui/Input'
    import Label from 'wind-ui/Label'
...
<Tabs items={['Preview', 'code']}>
  ...
  <Tabs.Tab value='Code'>
    ...
    import React from 'react'
    import Input from 'wind-ui/Input'
    import InputGroup from 'wind-ui/InputGroup'
    import InputAdornment from 'wind-ui/InputAdornment'
...
<Tabs items={['Preview', 'code']}>
  ...
  <Tabs.Tab value='Code'>
    ```jsx showLineNumbers
    import React from 'react'
    import Textarea from 'wind-ui/Textarea'
